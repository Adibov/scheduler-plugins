...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*GitlabRunnerSchedulerArgs)(nil), (*config.GitlabRunnerSchedulerArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_GitlabRunnerSchedulerArgs_To_config_GitlabRunnerSchedulerArgs(a.(*GitlabRunnerSchedulerArgs), b.(*config.GitlabRunnerSchedulerArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.GitlabRunnerSchedulerArgs)(nil), (*GitlabRunnerSchedulerArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_GitlabRunnerSchedulerArgs_To_v1_GitlabRunnerSchedulerArgs(a.(*config.GitlabRunnerSchedulerArgs), b.(*GitlabRunnerSchedulerArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_GitlabRunnerSchedulerArgs_To_config_GitlabRunnerSchedulerArgs(in *GitlabRunnerSchedulerArgs, out *config.GitlabRunnerSchedulerArgs, s conversion.Scope) error {
	return nil
}

// Convert_v1_GitlabRunnerSchedulerArgs_To_config_GitlabRunnerSchedulerArgs is an autogenerated conversion function.
func Convert_v1_GitlabRunnerSchedulerArgs_To_config_GitlabRunnerSchedulerArgs(in *GitlabRunnerSchedulerArgs, out *config.GitlabRunnerSchedulerArgs, s conversion.Scope) error {
	return autoConvert_v1_GitlabRunnerSchedulerArgs_To_config_GitlabRunnerSchedulerArgs(in, out, s)
}

func autoConvert_config_GitlabRunnerSchedulerArgs_To_v1_GitlabRunnerSchedulerArgs(in *config.GitlabRunnerSchedulerArgs, out *GitlabRunnerSchedulerArgs, s conversion.Scope) error {
	return nil
}

// Convert_config_GitlabRunnerSchedulerArgs_To_v1_GitlabRunnerSchedulerArgs is an autogenerated conversion function.
func Convert_config_GitlabRunnerSchedulerArgs_To_v1_GitlabRunnerSchedulerArgs(in *config.GitlabRunnerSchedulerArgs, out *GitlabRunnerSchedulerArgs, s conversion.Scope) error {
	return autoConvert_config_GitlabRunnerSchedulerArgs_To_v1_GitlabRunnerSchedulerArgs(in, out, s)
}
