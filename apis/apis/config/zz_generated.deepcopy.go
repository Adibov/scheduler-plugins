...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GitlabRunnerSchedulerArgs) DeepCopyInto(out *GitlabRunnerSchedulerArgs) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GitlabRunnerSchedulerArgs.
func (in *GitlabRunnerSchedulerArgs) DeepCopy() *GitlabRunnerSchedulerArgs {
	if in == nil {
		return nil
	}
	out := new(GitlabRunnerSchedulerArgs)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *GitlabRunnerSchedulerArgs) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
